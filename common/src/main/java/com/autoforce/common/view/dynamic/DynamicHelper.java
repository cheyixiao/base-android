...
import com.autoforce.common.utils.ImageLoaderUtils;
...
public class DynamicHelper {
    ...
    private static void applyTextAllCaps(View view, DynamicProperty dynProp) {

        if (view instanceof TextView) {
            TextView textView = (TextView) view;
            textView.setAllCaps(dynProp.getValueBoolean());
        }
    }
...
//                break;
                ...
                break;
                case URL: {
                    ImageLoaderUtils.loadImage(property.getUrl(), ((ImageView) view), -1, -1, null);
                }
                break;
            }
        }
